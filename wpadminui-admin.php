...
class wpui_options
{
    ...
    {        
        ...
        add_settings_field(
            'wpui_admin_menu_dashboard', // ID
           __("Hide Dashboard in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_dashboard_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_posts', // ID
           __("Hide Posts in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_posts_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_media', // ID
           __("Hide Media in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_media_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_pages', // ID
           __("Hide Pages in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_pages_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_comments', // ID
           __("Hide Comments in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_comments_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_appearance', // ID
           __("Hide Appearance in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_appearance_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_plugins', // ID
           __("Hide Plugins in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_plugins_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_users', // ID
           __("Hide Users in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_users_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );

        add_settings_field(
            'wpui_admin_menu_tools', // ID
           __("Hide Tools in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_tools_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );         

        add_settings_field(
            'wpui_admin_menu_settings', // ID
           __("Hide Settings in admin menu?","wpui"), // Title
            array( $this, 'wpui_admin_menu_settings_callback' ), // Callback
            'wpui-settings-admin-menu', // Page
            'wpui_setting_section_admin_menu' // Section           
        );
    ...
    //Admin Menu
    public function wpui_admin_menu_dashboard_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_dashboard']);
        
        echo '<input id="wpui_admin_menu_dashboard" name="wpui_admin_menu_option_name[wpui_admin_menu_dashboard]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_dashboard">'. __( 'Hide Dashboard menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_dashboard'])) {
            esc_attr( $this->options['wpui_admin_menu_dashboard']);
        }
    } 

    public function wpui_admin_menu_posts_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_posts']);
        
        echo '<input id="wpui_admin_menu_posts" name="wpui_admin_menu_option_name[wpui_admin_menu_posts]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_posts">'. __( 'Hide Posts menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_posts'])) {
            esc_attr( $this->options['wpui_admin_menu_posts']);
        }
    } 

    public function wpui_admin_menu_media_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_media']);
        
        echo '<input id="wpui_admin_menu_media" name="wpui_admin_menu_option_name[wpui_admin_menu_media]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_media">'. __( 'Hide Media menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_media'])) {
            esc_attr( $this->options['wpui_admin_menu_media']);
        }
    } 

    public function wpui_admin_menu_pages_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_pages']);
        
        echo '<input id="wpui_admin_menu_pages" name="wpui_admin_menu_option_name[wpui_admin_menu_pages]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_pages">'. __( 'Hide Pages menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_pages'])) {
            esc_attr( $this->options['wpui_admin_menu_pages']);
        }
    } 

    public function wpui_admin_menu_comments_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_comments']);
        
        echo '<input id="wpui_admin_menu_comments" name="wpui_admin_menu_option_name[wpui_admin_menu_comments]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_comments">'. __( 'Hide Comments menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_comments'])) {
            esc_attr( $this->options['wpui_admin_menu_comments']);
        }
    } 

    public function wpui_admin_menu_appearance_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_appearance']);
        
        echo '<input id="wpui_admin_menu_appearance" name="wpui_admin_menu_option_name[wpui_admin_menu_appearance]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_appearance">'. __( 'Hide Appearance menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_appearance'])) {
            esc_attr( $this->options['wpui_admin_menu_appearance']);
        }
    } 

    public function wpui_admin_menu_plugins_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_plugins']);
        
        echo '<input id="wpui_admin_menu_plugins" name="wpui_admin_menu_option_name[wpui_admin_menu_plugins]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_plugins">'. __( 'Hide Plugins menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_plugins'])) {
            esc_attr( $this->options['wpui_admin_menu_plugins']);
        }
    } 

    public function wpui_admin_menu_users_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_users']);
        
        echo '<input id="wpui_admin_menu_users" name="wpui_admin_menu_option_name[wpui_admin_menu_users]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_users">'. __( 'Hide Users menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_users'])) {
            esc_attr( $this->options['wpui_admin_menu_users']);
        }
    } 

    public function wpui_admin_menu_tools_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_tools']);
        
        echo '<input id="wpui_admin_menu_tools" name="wpui_admin_menu_option_name[wpui_admin_menu_tools]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_tools">'. __( 'Hide Tools menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_tools'])) {
            esc_attr( $this->options['wpui_admin_menu_tools']);
        }
    } 

    public function wpui_admin_menu_settings_callback()
    {
        $options = get_option( 'wpui_admin_menu_option_name' );  
        
        $check = isset($options['wpui_admin_menu_settings']);
        
        echo '<input id="wpui_admin_menu_settings" name="wpui_admin_menu_option_name[wpui_admin_menu_settings]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
        echo '<label for="wpui_admin_menu_settings">'. __( 'Hide Settings menu?', 'wpui' ) .'</label>';
        
        if (isset($this->options['wpui_admin_menu_settings'])) {
            esc_attr( $this->options['wpui_admin_menu_settings']);
        }
    } 
    ...
    public function wpui_profil_visual_editor_callback()
    {
        ...
        echo '<input id="wpui_profil_visual_editor" name="wpui_metaboxes_option_name[wpui_profil_visual_editor]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
    ...
    public function wpui_profil_admin_color_scheme_callback()
    {
        ...
        echo '<input id="wpui_profil_admin_color_scheme" name="wpui_metaboxes_option_name[wpui_profil_admin_color_scheme]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
    ...
    public function wpui_profil_default_color_scheme_callback()
    {
        ...
        echo '<input id="wpui_profil_default_color_scheme_none" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_default" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_light" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_blue" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_coffee" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_ectoplasm" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_midnight" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_ocean" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
        ...
        echo '<input id="wpui_profil_default_color_scheme_sunrise" name="wpui_metaboxes_option_name[wpui_profil_default_color_scheme]" type="radio"';
    ...
    public function wpui_profil_keyword_shortcuts_callback()
    {
        ...
        echo '<input id="wpui_profil_keyword_shortcuts" name="wpui_metaboxes_option_name[wpui_profil_keyword_shortcuts]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
    ...
    public function wpui_profil_show_toolbar_callback()
    {
        ...
        echo '<input id="wpui_profil_show_toolbar" name="wpui_metaboxes_option_name[wpui_profil_show_toolbar]" type="checkbox"';
        if ('1' == $check) echo 'checked="yes"'; 
        echo ' value="1"/>';
