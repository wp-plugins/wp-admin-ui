...
//Dashboard
function wpui_admin_menu_dashboard() {
	$wpui_admin_menu_dashboard_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_dashboard_option ) ) {
		foreach ($wpui_admin_menu_dashboard_option as $key => $wpui_admin_menu_dashboard_value)
			$options[$key] = $wpui_admin_menu_dashboard_value;
		 if (isset($wpui_admin_menu_dashboard_option['wpui_admin_menu_dashboard'])) { 
		 	return $wpui_admin_menu_dashboard_option['wpui_admin_menu_dashboard'];
		 }
	}
};

//Posts
function wpui_admin_menu_posts() {
	$wpui_admin_menu_posts_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_posts_option ) ) {
		foreach ($wpui_admin_menu_posts_option as $key => $wpui_admin_menu_posts_value)
			$options[$key] = $wpui_admin_menu_posts_value;
		 if (isset($wpui_admin_menu_posts_option['wpui_admin_menu_posts'])) { 
		 	return $wpui_admin_menu_posts_option['wpui_admin_menu_posts'];
		 }
	}
};

//Media
function wpui_admin_menu_media() {
	$wpui_admin_menu_media_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_media_option ) ) {
		foreach ($wpui_admin_menu_media_option as $key => $wpui_admin_menu_media_value)
			$options[$key] = $wpui_admin_menu_media_value;
		 if (isset($wpui_admin_menu_media_option['wpui_admin_menu_media'])) { 
		 	return $wpui_admin_menu_media_option['wpui_admin_menu_media'];
		 }
	}
};

//Pages
function wpui_admin_menu_pages() {
	$wpui_admin_menu_pages_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_pages_option ) ) {
		foreach ($wpui_admin_menu_pages_option as $key => $wpui_admin_menu_pages_value)
			$options[$key] = $wpui_admin_menu_pages_value;
		 if (isset($wpui_admin_menu_pages_option['wpui_admin_menu_pages'])) { 
		 	return $wpui_admin_menu_pages_option['wpui_admin_menu_pages'];
		 }
	}
};

//Comments
function wpui_admin_menu_comments() {
	$wpui_admin_menu_comments_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_comments_option ) ) {
		foreach ($wpui_admin_menu_comments_option as $key => $wpui_admin_menu_comments_value)
			$options[$key] = $wpui_admin_menu_comments_value;
		 if (isset($wpui_admin_menu_comments_option['wpui_admin_menu_comments'])) { 
		 	return $wpui_admin_menu_comments_option['wpui_admin_menu_comments'];
		 }
	}
};

//Appearance
function wpui_admin_menu_appearance() {
	$wpui_admin_menu_appearance_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_appearance_option ) ) {
		foreach ($wpui_admin_menu_appearance_option as $key => $wpui_admin_menu_appearance_value)
			$options[$key] = $wpui_admin_menu_appearance_value;
		 if (isset($wpui_admin_menu_appearance_option['wpui_admin_menu_appearance'])) { 
		 	return $wpui_admin_menu_appearance_option['wpui_admin_menu_appearance'];
		 }
	}
};

//Plugins
function wpui_admin_menu_plugins() {
	$wpui_admin_menu_plugins_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_plugins_option ) ) {
		foreach ($wpui_admin_menu_plugins_option as $key => $wpui_admin_menu_plugins_value)
			$options[$key] = $wpui_admin_menu_plugins_value;
		 if (isset($wpui_admin_menu_plugins_option['wpui_admin_menu_plugins'])) { 
		 	return $wpui_admin_menu_plugins_option['wpui_admin_menu_plugins'];
		 }
	}
};

//Users
function wpui_admin_menu_users() {
	$wpui_admin_menu_users_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_users_option ) ) {
		foreach ($wpui_admin_menu_users_option as $key => $wpui_admin_menu_users_value)
			$options[$key] = $wpui_admin_menu_users_value;
		 if (isset($wpui_admin_menu_users_option['wpui_admin_menu_users'])) { 
		 	return $wpui_admin_menu_users_option['wpui_admin_menu_users'];
		 }
	}
};

//Tools
function wpui_admin_menu_tools() {
	$wpui_admin_menu_tools_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_tools_option ) ) {
		foreach ($wpui_admin_menu_tools_option as $key => $wpui_admin_menu_tools_value)
			$options[$key] = $wpui_admin_menu_tools_value;
		 if (isset($wpui_admin_menu_tools_option['wpui_admin_menu_tools'])) { 
		 	return $wpui_admin_menu_tools_option['wpui_admin_menu_tools'];
		 }
	}
};

//Settings
function wpui_admin_menu_settings() {
	$wpui_admin_menu_settings_option = get_option("wpui_admin_menu_option_name");
	if ( ! empty ( $wpui_admin_menu_settings_option ) ) {
		foreach ($wpui_admin_menu_settings_option as $key => $wpui_admin_menu_settings_value)
			$options[$key] = $wpui_admin_menu_settings_value;
		 if (isset($wpui_admin_menu_settings_option['wpui_admin_menu_settings'])) { 
		 	return $wpui_admin_menu_settings_option['wpui_admin_menu_settings'];
		 }
	}
};
...
function wpui_admin_menu_remove_pages(){
	if (wpui_admin_menu_dashboard() == '1') {
		remove_menu_page( 'index.php' );                  //Dashboard
	}
	if (wpui_admin_menu_posts() == '1') {
		remove_menu_page( 'edit.php' );                   //Posts
	}
	if (wpui_admin_menu_media() == '1') {
		remove_menu_page( 'upload.php' );                 //Media
	}
	if (wpui_admin_menu_pages() == '1') {
		remove_menu_page( 'edit.php?post_type=page' );    //Pages
	}
	if (wpui_admin_menu_comments() == '1') {
		remove_menu_page( 'edit-comments.php' );          //Comments
	}
	if (wpui_admin_menu_appearance() == '1') {
		remove_menu_page( 'themes.php' );                 //Appearance
	}
	if (wpui_admin_menu_plugins() == '1') {
		remove_menu_page( 'plugins.php' );                //Plugins
	}
	if (wpui_admin_menu_users() == '1') {
		remove_menu_page( 'users.php' );                  //Users
	}
	if (wpui_admin_menu_tools() == '1') {
		remove_menu_page( 'tools.php' );                  //Tools
	}
	if (wpui_admin_menu_settings() == '1') {
		remove_menu_page( 'options-general.php' );        //Settings
	}
}
add_action( 'admin_menu', 'wpui_admin_menu_remove_pages' );
